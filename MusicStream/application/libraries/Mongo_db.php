...
Class Mongo_db{
	...
	//collection Names
    var $ability_tbl = "ABILITY_TBL";
    var $category_tbl = "CATEGORY_TBL";
    var $chat_tbl = "CHAT_TBL";
    var $crush_tbl = "CRUSH_TBL";
    var $crush_user_tbl = "CRUSH_USER_TBL";
    var $donatephone_tbl = "DONATEPHONE_TBL";
    var $donate_tbl = "DONATE_TBL";
    var $fgroup_tbl = "FGROUP_TBL";
    var $friend_tbl = "FRIEND_TBL";
    var $friend_est_tbl = "FRIEND_EST_TBL";
    var $friend_help_tbl = "FRIEND_HELP_TBL";
    var $newenergy_tbl = "NEWENERGY_TBL";
    var $ordcontent_tbl = "ORDCONTENT_TBL";
    var $orderplate_tbl = "ORDERPLATE_TBL";
    var $order_tbl = "ORDER_TBL";
    var $star_tbl = "STAR_TBL";
    var $tgroup_tbl = "TGROUP_TBL";    
    var $twitter_tbl = "TWITTER_TBL";
    var $user_tbl = "USER_TBL";
    var $tgroup_est_tbl = "TGROUP_EST_TBL";
    var $tgroup_info_tbl = "TGROUP_INFO_TBL";
    var $tleague_tbl = "TLEAGUE_TBL";
    var $tround_tbl = "TROUND_TBL";
    var $tleague_result_tbl = "TLEAGUE_RESULT_TBL";
	var $challenge_tbl = "TGROUP_CHALLENGE_TBL";
	var $token_tbl = "TOKEN_TBL";
	...
	* Get the documents where the value of a $field is greater than $x
	*
	* @usage : $this->mongo_db->where_eq('foo', 20);
	*/
	public function where_eq($field = "", $x)
	{
		if (!isset($field))
		{
			show_error("Mongo field is require to perform greater then query.", 500);
